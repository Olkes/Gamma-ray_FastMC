...
def write_script(settings):
    ...
    run_dir = "/user/olkes/FastMC/runit/"
    ...
    fout.write('PATH=/data/xenon/joranang/anaconda/bin:$PATH \n')
    fout.write('source activate fastMC\n')
    ...
    os.system('qsub -q generic7 -e '+log_dir+' -o '+log_dir+' '+scriptfile)
